<div class="main">
    <div class="main-slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <a target="_blank" href="#"><img src="<?php $this->asset('img/slide3.jpg') ?>" alt="websoft3"/></a>
                <span><a href="#">دوره آموزش صفرتاصد php در وبسافت3</a> </span>
            </div>
            <div class="item">
                <a target="_blank" href="#"><img src="<?php $this->asset('img/slide4.jpg') ?>" alt="websoft3"/></a>
            ...
            <div class="container">
                ...
                <?php foreach ($products as $product): ?>
                    <article class="post">
                        ...
                        <div class="post-title">
                            <h2><a target="_blank" href="/single/4" dideo-checked="true"><?php echo $product->title; ?></a>
                            </h2>
                        </div>
                        <div class="clearfix"></div>
                        <div class="post-txt">
